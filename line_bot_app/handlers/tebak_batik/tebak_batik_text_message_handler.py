...
class TebakBatikTextMessageHandler:
    def tebak_batik_text_message_handler_function(self, event, line_bot_api):
        ...
        if message in TebakBatikConstants.OPTIONS.value:
            if UserBatikGameModel.get_game_counter_by_user_id(idUser) >= TebakBatikConstants.TEBAK_BATIK_TOTAL_QUESTIONS.value:
