...
class FlagQuizTextMessageHandlers:
    def flag_quiz_text_message_handler_function(self, event, line_bot_api):
        ...
        elif message in FlagQuizConstants.OPTIONS.value and UserFlagGameModel.get_game_counter_by_user_id(idUser) < FlagQuizConstants.FLAG_QUIZ_TOTAL_QUESTIONS.value:
